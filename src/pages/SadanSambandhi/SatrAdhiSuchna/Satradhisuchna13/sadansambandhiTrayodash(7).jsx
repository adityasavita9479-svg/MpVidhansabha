...
// // 🗂 Data for the 13th Vidhan Sabha – Seventh Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanmon10.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakmon10.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinmon10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdmon10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmmon10.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaSeventhSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2010)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaSeventhSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaSeventhSession() {
const navigate = useNavigate();
