...
// // 🗂 Data for the 13th Vidhan Sabha – Fourth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANwin09.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/PATRAKwin09.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/DINwin09.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdwin09.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmwin09.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaFourthSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(नवम्बर, 2009)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaFourthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaFourthSession() {
const navigate = useNavigate();
