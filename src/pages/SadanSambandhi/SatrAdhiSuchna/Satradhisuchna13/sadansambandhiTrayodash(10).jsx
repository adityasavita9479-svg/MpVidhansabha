...
// // 🗂 Data for the 13th Vidhan Sabha – Tenth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanmon11.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakmon11.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinmon11.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdmon11.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmmon11.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaTenthSession = () => {
...
//         <h2 style={styles.sessionTitle}>दशम् सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2011)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaTenthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaTenthSession() {
const navigate = useNavigate();
