...
// // 🗂 Data for the 13th Vidhan Sabha – Special Session (Sixth Session)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANsp10.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/PATRAKsp10.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/DINsp10.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaSpecialSixthSession = () => {
...
//         <h2 style={styles.sessionTitle}>विशेष सत्र (षष्ठ सत्र)</h2>
//         <h3 style={styles.sessionPeriod}>(मई, 2010)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaSpecialSixthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaSpecialSixthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>विशेष सत्र (षष्ठ सत्र) (मई, 2010)</p>
        </div>
