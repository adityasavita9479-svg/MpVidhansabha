...
// // 🗂 Data for the 13th Vidhan Sabha – Eighth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanwin10.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakwin10.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinwin10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdwin10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmwin10.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaEighthSession = () => {
...
//         <h2 style={styles.sessionTitle}>अष्टम सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(नवम्बर-दिसम्बर, 2010)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaEighthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaEighthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>अष्टम सत्र (नवम्बर-दिसम्बर, 2010)</p>
        </div>
