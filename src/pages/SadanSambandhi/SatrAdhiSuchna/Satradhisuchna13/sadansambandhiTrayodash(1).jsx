...
// // 🗂 Data for the 13th Vidhan Sabha – First Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amansp09.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patraksp09.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinsp09.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaFirstSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(जनवरी, 2009)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaFirstSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaFirstSession() {
const navigate = useNavigate();
