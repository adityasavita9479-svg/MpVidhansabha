...
// // 🗂 Data for the 13th Vidhan Sabha – Thirteenth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanmon12.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakmon12.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinmon12.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdmon12.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmmon12.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaThirteenthSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2012)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaThirteenthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaThirteenthSession() {
const navigate = useNavigate();
