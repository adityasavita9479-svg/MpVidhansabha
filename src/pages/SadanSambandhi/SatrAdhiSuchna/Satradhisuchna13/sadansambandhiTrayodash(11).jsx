...
// // 🗂 Data for the 13th Vidhan Sabha – Eleventh Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanwin11.pdf  " },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakwin11.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinwin11.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdwin11.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmwin11.pdf" },
// ];

// // 🎨 Styles (same as previous sessions)
// const styles = {
//   container: {
//     maxWidth: "1100px",
//     margin: "0 auto",
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaEleventhSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(नवम्बर-दिसम्बर, 2011)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaEleventhSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaEleventhSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>एकादश सत्र (नवम्बर-दिसम्बर, 2011)</p>
        </div>
