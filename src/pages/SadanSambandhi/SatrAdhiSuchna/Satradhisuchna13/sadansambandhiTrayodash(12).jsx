...
// // 🗂 Data for the 13th Vidhan Sabha – Twelfth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud12.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud12.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud12.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud12.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud12.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaTwelfthSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(फरवरी-अप्रैल, 2012)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaTwelfthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaTwelfthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>द्वादश सत्र (फरवरी-अप्रैल, 2012)</p>
        </div>
