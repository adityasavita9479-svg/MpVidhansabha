...
// // 🗂 Data for the 13th Vidhan Sabha – Ninth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud11.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud11.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud11.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud11.pdf "},
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud11.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaNinthSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(फरवरी-अप्रैल, 2011)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaNinthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaNinthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>नवम सत्र (फरवरी-अप्रैल, 2011)</p>
        </div>
