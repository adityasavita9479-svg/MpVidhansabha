...
// // 🗂 Data for the 13th Vidhan Sabha – Budget Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud10.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud10.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud10.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud10.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaFifthBudgetSession = () => {
...
//         <h2 style={styles.sessionTitle}>बजट सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(फरवरी - मार्च, 2010)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaFifthBudgetSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaFifthBudgetSession() {
const navigate = useNavigate();
