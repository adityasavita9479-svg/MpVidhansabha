...
// // 🗂 Data for the 13th Vidhan Sabha – Seventeenth Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanmon13.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakmon13.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinmon13.pdf " },
//   { title: "सत्र की बैठकों की सामान्य सूची (8 जुलाई, 2013)", pdf: "/misc/adhisuchna/samanyasuchimon13.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdmon13.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmmon13.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaSeventeenthSession = () => {
...
//         <h2 style={styles.sessionTitle}>सत्र सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2013 – Monsoon Session)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaSeventeenthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaSeventeenthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>सत्र सत्र (जुलाई, 2013 – Monsoon Session)</p>
        </div>
