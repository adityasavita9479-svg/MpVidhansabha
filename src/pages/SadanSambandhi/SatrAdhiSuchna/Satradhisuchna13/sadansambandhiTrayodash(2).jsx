...
// // 🗂 Data for the 13th Vidhan Sabha – Second Session
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud09.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud09.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud09.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud09.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud09.pdf" },
// ];
...
// // 🏛️ Main Component
// const TrayodashVidhanSabhaSecondSession = () => {
...
//         <h3 style={styles.sessionPeriod}>(मार्च, 2009)</h3>
//       </div>
...
// export default TrayodashVidhanSabhaSecondSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function TrayodashVidhanSabhaSecondSession() {
const navigate = useNavigate();
