...
// // Data for the session items with placeholder PDF paths
// const sessionItems = [
//   { title: "सत्र अधिसूचना निरस्त करने का राज्यपाल महोदया का आदेश", pdf: "/misc/adhisuchna/prevdload/SessionCancellationNotification_15_7.pdf" },
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/prevdload/aman_15_7_0.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/prevdload/patrak_15_7_0.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/prevdload/din_15_7_0.pdf" },
//   { title: "सत्र की बैठकों की सामान्य सूची" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartm-15-7-0.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartd-15-7-0.pdf" },
// ];
...
// // Main Component
// const PanchadashVidhanSabhaSeventhSession = () => {
//   return (
...
//         <h2 style={styles.sessionTitle}>सप्तम् सत्र (निरस्त)</h2>
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2020)</h3>
//       </div>
...
// export default PanchadashVidhanSabhaSeventhSession;
import React from "react";
import { Link } from "react-router-dom";
...
const sessionItems = [
  {
    title: "सत्र अधिसूचना निरस्त करने का राज्यपाल महोदया का आदेश",
    pdf: "/misc/adhisuchna/prevdload/SessionCancellationNotification_15_7.pdf",
  },
  { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/prevdload/aman_15_7_0.pdf" },
  { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/prevdload/patrak_15_7_0.pdf" },
  { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/prevdload/din_15_7_0.pdf" },
  { title: "सत्र की बैठकों की सामान्य सूची" },
  {
    ...
    pdf: "/misc/adhisuchna/prevdload/rchartm-15-7-0.pdf",
  },
  {
    title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये",
    pdf: "/misc/adhisuchna/prevdload/rchartd-15-7-0.pdf",
  },
];

export default function PanchadashVidhanSabhaSeventhSession() {
  return (
