...
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/prevdload/aman_15_4.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/prevdload/patrak_15_4.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/prevdload/din_15_4.pdf" },
//   { title: "सत्र की बैठकों की सामान्य सूची", pdf: "/misc/adhisuchna/prevdload/samanayasuchi_15_4.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartm-15-4.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartd-15-4.pdf" },
// ];

// const PanchadashVidhanSabhaFourthSession = () => {
//   const styles = {
//     container: {
//       maxWidth: "1100px",
//       margin: "40px auto",
...
//         <h3 style={styles.sessionPeriod}>(दिसम्बर, 2019)</h3>
//       </div>
...
// export default PanchadashVidhanSabhaFourthSession;
import React from "react";
import { Link } from "react-router-dom";
...
export default function PanchadashVidhanSabhaFourthSession() {
  return (
