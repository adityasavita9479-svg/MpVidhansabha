...
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/prevdload/aman_15_2.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/prevdload/patrak_15_2.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/prevdload/din_15_2.pdf" },
//   { title: "सत्र की बैठकों की सामान्य सूची", pdf: "/misc/adhisuchna/prevdload/samanayasuchi_15_2.pdf" },
//   { title: "पुनरीक्षित सामान्य सूची", pdf: "/misc/adhisuchna/prevdload/pssuchifeb2019.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartm-15-2.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/prevdload/rchartd-15-2.pdf" },
// ];

// const PanchadashVidhanSabhaSecondSession = () => {
//   const styles = {
//     container: {
//       maxWidth: "1100px",
//       margin: "40px auto",
...
//         <h2 style={styles.sessionTitle}>द्वितीय सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(फरवरी, 2019)</h3>
//       </div>
...
// export default PanchadashVidhanSabhaSecondSession;
import React from "react";
import { Link } from "react-router-dom";
...
export default function PanchadashVidhanSabhaSecondSession() {
  return (
