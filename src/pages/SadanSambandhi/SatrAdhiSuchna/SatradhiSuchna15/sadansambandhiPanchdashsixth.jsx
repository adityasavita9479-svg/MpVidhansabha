...
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/adhisuchna/prevdload/aman_15_6.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/adhisuchna/prevdload/din_15_6.pdf" },
// ];
...
// // Main Component
// const PanchadashVidhanSabhaShashtamSession = () => {
//   return (
...
//         <h2 style={styles.sessionTitle}>षष्टम् सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(मार्च, 2020)</h3>
//       </div>
...
// export default PanchadashVidhanSabhaShashtamSession;
import React from "react";
import { Link } from "react-router-dom";
...
export default function PanchadashVidhanSabhaShashtamSession() {
  return (
