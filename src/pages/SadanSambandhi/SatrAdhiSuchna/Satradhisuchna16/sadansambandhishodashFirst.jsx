...
// // // Data for प्रथम सत्र with PDF links
// // const sessionDocuments = [
// //   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/prevdload/aman_16_1.pdf" },
// //   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/prevdload/patrak_16_1.pdf" },
// //   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/prevdload/din_16_1.pdf" },
// //   { title: "सत्र में बैठकों की सामान्य सूची" }, // No PDF
// // ];

// // const ShodashFirstSession = () => {
// //   const styles = {
// //     container: {
// //       maxWidth: "1100px",
// //       margin: "40px auto",
...
// //       <h3 style={styles.subHeading}>प्रथम सत्र (दिसम्बर, 2023)</h3>
...
// // export default ShodashFirstSession;
// import React from "react";
...
// export default function ShodashFirstSession() {
//   const navigate = useNavigate();

//   return (
//     <div className="comm-page">

//       {/* ⭐ HERO SECTION (Same layout as your provided seventh session) */}
...
//       {/* ⭐ GRID SECTION (same as seventh session style) */}
...
export default function ShodashFirstSession() {
  ...
  return (
    <div className="panch-page">
      ...
      {/* ⭐ HERO SECTION — SAME OVERLAY SYSTEM */}
      ...
      {/* ⭐ DOCUMENT GRID — SAME AS OTHER PAGE */}
      <section className="panch-section">
        <div className="panch-grid">
          {sessionDocuments.map((doc, index) => (
            <div
