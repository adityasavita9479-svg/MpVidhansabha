...
// // Data for एकादश सत्र (Feb–Apr 2007 Session)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud07.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud07.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud07.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud07.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud07.pdf" },
// ];
...
//         <h3 style={styles.sessionPeriod}>Feb–Apr 2007 Session</h3>
//       </div>
...
// export default DwadashEleventhSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashEleventhSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="panch-hero-text">
          ...
          <p>एकादश सत्र – Feb–Apr 2007 Session</p>
        </div>
