...
// // Data for चतुर्थ सत्र (Winter Session 2004)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANwin04.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdwin04.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmwin04.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/PATRAKwin04.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/DINwin04.pdf" },
// ];
...
//         <h3 style={styles.sessionPeriod}>Winter Session 2004</h3>
//       </div>
...
// export default DwadashFourthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashFourthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>चतुर्थ सत्र – Winter Session 2004</p>
        </div>
