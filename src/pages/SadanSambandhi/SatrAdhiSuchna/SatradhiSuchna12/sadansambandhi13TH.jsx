...
// // Data for द्वादश सत्र (July–August 2007 Session)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanwin07.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdwin07.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmwin07.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakwin07.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinwin07.pdf" },
// ];
...
//         <h3 style={styles.sessionPeriod}>July–August 2007 Session</h3>
//       </div>
...
// export default DwadashThirteenSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashThirteenSession() {
  const navigate = useNavigate();
