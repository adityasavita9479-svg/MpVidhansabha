...
// // Data for अष्टम सत्र (Budget Session 2006)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANbud06.pdf/DwadashEighth(1).pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud06.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud06.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/PATRAKbud06.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud06.pdf" },
// ];
...
//         <h3 style={styles.sessionPeriod}>Budget Session 2006</h3>
//       </div>
...
// export default DwadashEighthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashEighthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="panch-hero-text">
          ...
          <p>अष्टम सत्र – Budget Session 2006</p>
        </div>
