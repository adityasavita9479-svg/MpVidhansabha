...
// // Data for नवम सत्र (Monsoon Session 2006)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANbud06.pdf" },
...
//         <h3 style={styles.sessionPeriod}>Monsoon Session 2006</h3>
//       </div>
...
// export default DwadashNinthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashNinthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="panch-hero-text">
          ...
          <p>नवम सत्र – Monsoon Session 2006</p>
        </div>
