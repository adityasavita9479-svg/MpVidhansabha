...
// // Data for चतुर्दश सत्र (February–April 2008 Session)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/amanbud08.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud08.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud08.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrakbud08.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/DINBUD08.pdf" },
// ];
...
// // Main Component
// const DwadashFourteenthSession = () => {
...
//         <h3 style={styles.sessionPeriod}>February–April 2008 Session</h3>
//       </div>
...
// export default DwadashFourteenthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashFourteenthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="panch-hero-text">
          ...
          <p>चतुर्दश सत्र – February–April 2008 Session</p>
        </div>
