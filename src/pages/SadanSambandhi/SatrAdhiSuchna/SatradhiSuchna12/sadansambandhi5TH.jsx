...
// // Data for पंचम सत्र (Budget Session 2005)
// const sessionItems = [
//   { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/AMANbud05.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartdbud05.pdf" },
//   { title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartmbud05.pdf" },
//   { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/PATRAKbud05.pdf" },
//   { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/dinbud05.pdf" },
// ];
...
//         <h3 style={styles.sessionPeriod}>Budget Session 2005</h3>
//       </div>
...
// export default DwadashFifthSession;
import React from "react";
import { useNavigate } from "react-router-dom";
...
export default function DwadashFifthSession() {
const navigate = useNavigate();
    ...
    <div className="panch-hero-content">
      <div className="panch-hero-row" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div className="panch-hero-text">
          ...
          <p>पंचम सत्र – Budget Session 2005</p>
        </div>
