...
// // 🗂 Data for the 14th Vidhan Sabha – 6th Session
// const sessionItems = [
//   {
//     title: "सत्र आमंत्रण की अधिसूचना",
//     pdf: "/misc/adhisuchna/14th_session/amantran_14_6.pdf",
//   },
//   {
//     title: "पत्रक भाग - 2",
//     pdf: "/misc/adhisuchna/14th_session/patrak_14_6.pdf",
//   },
// ];
...
// // 🏛️ Main Component
// const ChaturdashVidhanSabhaSixthSession = () => {
...
//         <h2 style={styles.sessionTitle}>षष्ठम सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(मार्च, 2015)</h3>
//       </div>
...
// export default ChaturdashVidhanSabhaSixthSession;
import React from "react";
import { useNavigate } from "react-router-dom";

// 14th Vidhan Sabha – 6th Session
const sessionItems = [
  {
    title: "सत्र आमंत्रण की अधिसूचना",
    pdf: "/misc/adhisuchna/14th_session/amantran_14_6.pdf",
...
export default function ChaturdashVidhanSabhaSixthSession() {
  const navigate = useNavigate();
        ...
        <div className="panch-hero-content">
          ...
          <div className="panch-hero-row">
            ...
            <div className="panch-hero-text">
              <h1>чतुर्दश विधान सभा</h1>
              <p>षष्ठम सत्र (मार्च, 2015)</p>
            </div>
