...
//     pdf: "/misc/adhisuchna/aman-3-2015.pdf",
//   },
//   {
//     title: "पत्रक भाग - 2",
//     pdf: "/misc/adhisuchna/patrak-3-2015.pdf",
//   },
//   {
//     title: "सत्र की बैठकों की दिनदर्शिका",
//     pdf: "/misc/adhisuchna/din-3-2015.pdf",
//   },
//   {
//     title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-विभागों के लिये",
//     pdf: "/misc/adhisuchna/rchartd-3-2015.pdf",
//   },
//   {
//     title: "प्रश्‍नोत्‍तरों के लिये चक्रानुक्रम-सदस्‍यों के लिये",
//     pdf: "/misc/adhisuchna/rchartm-3-2015.pdf",
//   },
//   {
//     title: "सत्र की बैठकों की सामान्य सूची",
//     pdf: "/misc/adhisuchna/samanayasuchi_mon15.pdf",
//   },
// ];
...
// // 🏛️ Main Component
// const ChaturdashVidhanSabhaSeventhSession = () => {
...
//         <h2 style={styles.sessionTitle}>सप्तम सत्र</h2>
//         <h3 style={styles.sessionPeriod}>(जुलाई, 2015)</h3>
//       </div>
...
// export default ChaturdashVidhanSabhaSeventhSession;
import React from "react";
import { useNavigate } from "react-router-dom";

// 14th Vidhan Sabha – 7th Session
const sessionItems = [
  { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/aman-3-2015.pdf" },
  { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrak-3-2015.pdf" },
  { title: "सत्र की बैठकों की दिनदर्शिका", pdf: "/misc/adhisuchna/din-3-2015.pdf" },
  { title: "प्रश्‍नोत्‍तरों के लिये چक्रानुक्रम-विभागों के लिये", pdf: "/misc/adhisuchna/rchartd-3-2015.pdf" },
  { title: "प्रश्‍नोत्‍तरों के लिये چक्रानुक्रम-सदस्‍यों के लिये", pdf: "/misc/adhisuchna/rchartm-3-2015.pdf" },
  { title: "सत्र की बैठकों की सामान्य सूची", pdf: "/misc/adhisuchna/samanayasuchi_mon15.pdf" },
];

export default function ChaturdashVidhanSabhaSeventhSession() {
  const navigate = useNavigate();
