...
//     pdf: "/misc/adhisuchna/aman-8-2015.pdf",
//   },
//   {
//     title: "पत्रक भाग - 2",
//     pdf: "/misc/adhisuchna/patrak-8-2015.pdf",
//   },
// ];
...
// // 🏛️ Main Component
// const ChaturdashVidhanSabhaEigthSession = () => {
...
//   <h3 style={styles.sessionPeriod}>(नवम्बर, 2015)</h3>
// </div>
...
// export default ChaturdashVidhanSabhaEigthSession;
import React from "react";
import { useNavigate } from "react-router-dom";

// 14th Vidhan Sabha – 8th Session
const sessionItems = [
  { title: "सत्र आमंत्रण की अधिसूचना", pdf: "/misc/adhisuchna/aman-8-2015.pdf" },
  { title: "पत्रक भाग - 2", pdf: "/misc/adhisuchna/patrak-8-2015.pdf" },
];

export default function ChaturdashVidhanSabhaEigthSession() {
  const navigate = useNavigate();
