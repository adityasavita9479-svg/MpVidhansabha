    ...
    <div style={ntStyles.pageWrapper}>
      ...
      <div style={ntStyles.card}>
        <section style={ntStyles.section}>
          ...
          <InfoRow label="जन्म तिथि" value="14 जुलाई, 1929" />
          ...
          <InfoRow
            label="अभिरुचि"
            value="अध्यात्म, भारतीय विधाओं का अध्ययन तथा समाज सेवा"
          />
          <InfoRow
            label="स्थायी पता"
            value="81, महाकाल मार्ग, पोस्ट-हाटपीपल्या, जिला देवास (म.प्र.)"
          />
        </section>
...
const ntStyles = {
  ...
  tenure: { marginTop: "0.8rem", fontSize: "1rem", fontWeight: "600" },
  card: {
    backgroundColor: "white",
    borderRadius: 12,
