    ...
    <div className="page-wrapper">
      ...
      <div className="top-profile-card">
        <div className="photo-frame">
          <img
            src="/leaders/sp-Brij_Mohan_Mishra.jpg"
            alt="श्री बृजमोहन मिश्रा"
        ...
        <div className="name-frame">
          <h1>श्री बृजमोहन मिश्रा</h1>
          <h3>(भूतपूर्व अध्यक्ष, मध्यप्रदेश विधानसभा)</h3>
      ...
      <div className="card">
        ...
        <p className="death-notice">दिनांक 06.05.2004 को आपका देहावसान हो गया.</p>
      </div>
    </div>
  );
};
