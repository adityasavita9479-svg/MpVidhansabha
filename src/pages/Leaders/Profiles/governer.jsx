...
const GovernorProfile = () => {
  return (
    <div className="page-wrapper">
      {/* Separate Photo and Name Frames with Divider */}
      <div className="top-profile-card">
        {/* Photo Frame */}
        <div className="photo-frame">
          <img
            src="/leaders/governor_01.jpg" // Updated path for public folder
        ...
        <div className="name-frame">
          <h1 className="top-title">श्री मंगुभाई पटेल</h1>
          <h3 className="top-subtitle">माननीय राज्यपाल, मध्यप्रदेश</h3>
        </div>
      </div>
...
//         {/* Name Frame */}
//         <div className="name-frame">
//           <h1 className="top-title dark-light-text">श्री मंगुभाई पटेल</h1>
//           <h3 className="top-subtitle dark-light-text">
...
//       {/* Biography Section */}
//       <div className="card dark-light-text">
//         <h2 className="section-title dark-light-text">
//           सार्वजनिक एवं राजनीतिक जीवन का संक्षिप्त विकास क्रम-
//         </h2>

//         <p className="paragraph dark-light-text">
//           अध्‍यक्ष, भारतीय जनता पार्टी आदिवासी मोर्चा गुजरात. उपाध्‍यक्ष एवं महासचिव, गुजरात भारतीय जनता पार्टी. वर्ष 1982 से 1987 तक नवसारी नगर पालिका के सदस्‍य. वर्ष 1990-1995 में आठवीं, वर्ष 1995-1997 में नौवीं, वर्ष 1997-2002 में दसवीं, वर्ष 2002-2007 में ग्‍यारहवीं, वर्ष 2008-2012 में बारहवीं तथा वर्ष 2013-2017 में तेरहवीं गुजरात विधान सभा के सदस्‍य रहे. वर्ष 1995-1996 में आदिम जाति विकास कॉर्पोरेशन गांधीनगर, गुजरात के चेयरमेन. गुजरात सरकार में वर्ष 1998-2002 में जनजातीय कल्‍याण और कुटीर, उद्योग राज्‍य मंत्री (स्‍वतंत्र प्रभार). ...
//         </p>

//         <p className="bold-paragraph dark-light-text">
//           दिनांक 8 जुलाई, 2021 से राज्‍यपाल, मध्‍यप्रदेश.
//         </p>
//       </div>
//     </div>
...
// // InfoRow Component
// const InfoRow = ({ label, value }) => (
//   <div className="info-row dark-light-text">
//     <span className="info-label">{label}:</span>{" "}
//     <span className="info-value">{value}</span>
//   </div>
// );
