    ...
    <div className="profile-page">
      ...
      <div className="profile-header">
        <div className="profile-photo-container">
          <img
            src="/leaders/umangsingharlo.jpg"
        ...
        <div className="profile-name-box">
          <h1 className="profile-title">श्री उमंग सिंघार</h1>
      ...
      <div className="bio-card">
        ...
        <p className="bio-text">
          सन् 1994-2003 में जिला युवा कांग्रेस के अध्यक्ष. सन् 2008 में तेरहवीं
          विधान सभा के सदस्य निर्वाचित. सामान्य प्रशासन विभाग की परामर्शदात्री
          समिति एवं विधान सभा की याचिका समिति के सदस्य. अखिल भारतीय कांग्रेस
          कमेटी के राष्ट्रीय सचिव. कांग्रेस की राष्ट्रीय कार्यकारिणी के सदस्य.
          अखिल भारतीय कांग्रेस कमेटी की अनुसूचित जनजाति मोर्चा के सदस्य. प्रभारी
          झारखंड. सन् 2013 में चौदहवीं एवं सन् 2018 में पन्द्रहवीं विधान सभा के
          सदस्य निर्वाचित. दिनांक 29 दिसम्बर, 2018 से 20 मार्च, 2020 तक मंत्री वन
          विभाग रहे।
        </p>
        <p className="bio-text">
        ...
        <p className="bio-highlight">
          वर्तमान में: दिनांक 18 दिसम्बर, 2023 से नेता प्रतिपक्ष, मध्यप्रदेश
          विधान सभा।
        </p>
      </div>
    </div>
